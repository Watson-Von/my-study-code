...
public abstract class BaseListener<T> extends AnalysisEventListener<T> {
    ...
    private List<T> excelDataList = new ArrayList<>();
     ...
     * @Date: 2021/6/22 9:35
     **/
    public abstract void doAfterAllAnalysed(List<T> list);

    /**
     * @Author: fengHangWen
     * @Description: 自定义excel 解析数据
     * @Date: 2021/6/22 9:42
     **/
    protected void setExcelDataList(List<T> excelDataList) {
    ...
    protected void printInsertSqlScript(List<List<SqlUtils.ValueType>> insertDataList) {
        ...
        List<List<List<SqlUtils.ValueType>>> partition = Lists.partition(insertDataList, 1000);
